...
<div class="admin-header">
    ...
    <a href="{{ route('admin.projects.index') }}" class="btn btn-outline-secondary btn-sm">← Listeye dön</a>
</div>

<div class="admin-card">
    <form id="projectCreateForm" action="{{ route('admin.projects.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-8">
                ...
                <p class="small text-muted">İş yeri projelerinde m², Aidat, Isıtma ve Bina Yaşı alanları yukarıdaki Konut / genel bölümden kullanılır.</p>
                </div>
                <hr class="my-4">
                ...
                <div class="form-group mb-3">
                    ...
                    <small class="text-muted">Sadece arsa projelerinde; geçerli JSON.</small>
            ...
            <div class="col-md-4">
                <div class="form-group mb-3">
                    <label for="images">Proje Görselleri</label>
        ...
        <hr>
        <button type="submit" class="btn btn-admin" id="btnSubmitProject">Kaydet</button>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="confirmSaveModalLabel">Projeyi kaydet</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Kapat"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                Projeyi kaydetmek istediğinize emin misiniz?
            </div>
...
(function() {
    ...
    if (form && confirmModal && confirmBtn) {
        ...
        confirmBtn.addEventListener('click', function() {
            ...
            document.getElementById('btnSubmitProject').disabled = true;
